...
engine = create_engine(
    f'{os.getenv("POSTGRES_DRIVER")}://{os.getenv("POSTGRES_USER")}:{os.getenv("POSTGRES_PASSWORD")}@{os.getenv("POSTGRES_HOST") if not os.getenv("IS_LOCAL") else "localhost"}/{os.getenv("POSTGRES_DB")}', echo=True
)
